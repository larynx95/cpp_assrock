...
Lec28. Text RPG 6
https://www.youtube.com/watch?v=MbrjzBaab9U&list=PL4SIC1d_ab-b4zy_3FDRIiohszShOZ0PK&index=28
******************************************************************************/
...
int main() {
  ...
  tStoreWeapon[1].iMin = 60;
  tStoreWeapon[1].iMax = 80;
      ...
      case MM_MAP: {
        while (true) {
          ...
          while (true) {
            ...
            if (tPlayer.bEquip[EQ_WEAPON] == true) {
              // if player equiped with some weapon
              cout << "Attack Power: " << tPlayer.iAttackMin << " + "
                   << tPlayer.tEquip[EQ_WEAPON].iMin << " - "
                   << tPlayer.iAttackMax << " + "
                   << tPlayer.tEquip[EQ_WEAPON].iMax << endl;
            } else {
              cout << "Attack Power: " << tPlayer.iAttackMin << " - "
            ...
            if (tPlayer.bEquip[EQ_ARMOR] == true) {
              // if player equiped with some armor
              cout << "Defence Power: " << tPlayer.iArmorMin << " + "
        ...
        case MM_INVENTORY: {
          while (true) {
            ...
            cout << "Now player euqiped with " << tPlayer.tEquip[eq].strName
                 << "." << endl;
