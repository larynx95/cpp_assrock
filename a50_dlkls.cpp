...
Lec50. Double Linked List 3
https://www.youtube.com/watch?v=eT-q2ppaNUI&list=PL4SIC1d_ab-b4zy_3FDRIiohszShOZ0PK&index=50
******************************************************************************/
...
enum SORT_OPTION { SO_NONE, SO_ASCEND, SO_DESCEND };
...
void Sort(PLIST pList) {
  ...
  if (iOption <= SO_NONE || iOption > SO_DESCEND) {
    cout << "Wrong Input" << endl;
    system("clear");
    return;
  }
