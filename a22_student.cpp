...
Lec22. Student Records 3
https://www.youtube.com/watch?v=3kH8y7gp0Kg&list=PL4SIC1d_ab-b4zy_3FDRIiohszShOZ0PK&index=22
******************************************************************************/
      ...
      case MENU_DELETE:
        ...
        for (int i = 0; i < iStudentCount; i++) {
          if (strcmp(tStudentArr[i].strName, strName) == 0) {
            ...
            --iStudentCount;
            cout << "The record of the student was deleted." << endl;
          }
        }
        break;
      case MENU_SEARCH:
        cout << "~~~~~~ Search ~~~~~~" << endl;
        cin.ignore(1024, '\n');
        cout << "Enter a name that you want to find: ";
        cin.getline(strName, NAME_SIZE);
